function vlawe = computeVLAWEForOneVocabularyFromDocumentList(vocabulary, names, cache, numCentroidWords)
% Compute VLAWE representations for multiple documents
...
parfor i = 1:length(names)
  ...
  vlawe{i} = computeVLAWEForOneVocabularyFromDocument(vocabulary, fullPath, numCentroidWords);
  if nargs > 1
    % save to cache
