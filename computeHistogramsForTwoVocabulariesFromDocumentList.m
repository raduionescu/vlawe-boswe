function histograms = computeHistogramsForTwoVocabulariesFromDocumentList(posVocabulary, negVocabulary, names, cache, numCentroidWords, numBins)
...
parfor i = 1:length(names)
  ...
  histograms{i} = computeHistogramForTwoVocabulariesFromDocument(posVocabulary, negVocabulary, fullPath, numCentroidWords, numBins);
  if nargs > 1
    % save to cache
